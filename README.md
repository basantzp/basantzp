...
| :--- | :--- | :--- | :--- |
| **[172.20.3.17](https://github.com/basantzp/172.20.3.17)** | 🌐 **ISP Core Infrastructure Hub**: Enterprise Multi-Vendor Network Automation (`net-auto`), Optical Telemetry SOPs, Cisco SF350-24 20-Port Multi-ISP Layer 3 Distribution & Hardening. | `Cisco IOS` `Huawei VRP` `BDCOM` `Python` `Bash` `GPON OLT` `BGP` | 🟢 Active |
