...
| **[omarchy](https://github.com/basantzp/omarchy)** | Tailored, hyper-automated Arch Linux & Hyprland environment featuring macOS Sequoia-style Wi-Fi Control Center, Real-Time Focus Turbo Engine, and automated sync. | `Python` `GTK4` `Hyprland` `Waybar` `Systemd` | 🟢 Active |
