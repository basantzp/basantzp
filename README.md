...
| :--- | :--- | :--- | :--- |
| **[individuals](https://github.com/basantzp/individuals)** ([Live App](https://justapplyjobs.vercel.app)) | Autonomous Multi-Domain AI Career Engine across 8 disciplines (Web3, AI/ML, Fullstack, Cloud, Security), Google Gemini cold pitch studio, custom binary CV attachments (PDF/DOCX), client API hub (`/settings`), 9 currencies, and Gmail SSL SMTP auto-dispatch. | `Next.js 16` `React 19` `TypeScript` `Google Gemini` `Supabase` `Vercel` `Nodemailer` | 🟢 Active |
