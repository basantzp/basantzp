...
| :--- | :--- | :--- | :--- |
| **[brun-prop-forex-autonomous](https://github.com/basantzp/brun-prop-forex-autonomous)** | ⚡ Autonomous Android & Web 15M Statistical Trading System implementing Gian Luca Brun's World-Championship Triple Print, Wick Gap, GARCH Regime Flip & Prop Drawdown Shield. | `TypeScript` `React` `Kotlin` `Android` `TradingView` `Pine Script` | 🟢 Active |
