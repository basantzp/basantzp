...
| **[omarchy](https://github.com/basantzp/omarchy)** | Tailored, hyper-automated Arch Linux & Hyprland environment featuring macOS Sequoia-style Wi-Fi & Battery Control Centers, dynamic Waybar workstation/bandwidth telemetry, and an autonomous AI agent skill suite. | `Python` `GTK4` `Hyprland` `Waybar` `Agent Skills` | 🟢 Active |
