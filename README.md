...
# ⛓️ Hey there, I'm Basant Pokhrel! 👋

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=6366F1&center=true&vCenter=true&width=520&lines=Blockchain+Enthusiast+%26+Builder+⛓️;Smart+Contract+Explorer+📜;EVM+%26+DeFi+Mechanics+Learner+⚡;Open+Source+%26+Linux+Advocate+🐧)](https://git.io/typing-svg)

<p align="center">
  <b>Passionate about decentralized systems, smart contract architecture, and cryptographic consensus.</b><br>
...
I am a **Blockchain Enthusiast & Web3 Learner** driven by an insatiable curiosity for decentralized networks and cryptographic protocols. I believe the best way to master decentralized technology is by **learning through hands-on building**—spinning up custom testnets, writing and testing smart contracts, inspecting EVM transactions, and engineering reliable developer workflows.

- 🔭 **Currently Building & Researching**: EVM smart contract patterns, local testnet environments, decentralized APIs, and gas optimization strategies.
- 🌱 **Actively Learning**: Layer 2 rollups (Optimistic & ZK-Rollups), DeFi mechanics (AMMs, liquidity pools, flash loans), and Smart Contract Security Auditing.
- 💡 **Learning Philosophy**: Approaching every new concept with beginner's humility and an engineer's technical rigor.
- 🐧 **Environment**: Developed on Arch Linux with Hyprland and streamlined terminal tooling.
- 💬 **Let's Discuss**: Solidity, Hardhat, EVM opcodes, smart contract testing, or Linux system automation.
- 📫 **Get in Touch**: [basantpok90@gmail.com](mailto:basantpok90@gmail.com)

---

## 🛠️ Tech Stack & Web3 Toolbox
...
<p>
  ...
  <img src="https://img.shields.io/badge/Ethers.js-2656C7?style=for-the-badge&logoColor=white" alt="Ethers.js" />
...
| :--- | :--- | :--- | :--- |
| **[172.20.3.17](https://github.com/basantzp/172.20.3.17)** | 🌐 **ISP Core Infrastructure Hub**: Enterprise Multi-Vendor Network Automation (`net-auto`), Optical Telemetry SOPs, Zero-Mistake Loop-Free Defense, 28-Port Multi-ISP Layer 3 Distribution & Hardening. | `Cisco IOS` `Huawei VRP` `BDCOM` `Python` `Bash` `GPON OLT` `BGP` | 🟢 Active |
| **[cisco-switch](https://github.com/basantzp/cisco-switch)** | ⚡ **Cisco Switch Automation & Management**: Auto-Detect Serial Console Manager (`cisco`), Flex Links Autonomous Failover & Preemption, RSTP Loop Defense & Multi-ISP Carrier Blueprints. | `Cisco IOS` `Python` `Bash` `Serial UART` `FTDI` `RSTP` `Network Security` | 🟢 Active |
| **[basu-prop-forex-autonomous](https://github.com/basantzp/brun-prop-forex-autonomous)** | ⚡ **Basu Autonomous**: Android & Web 15M Statistical Trading System implementing World-Championship Triple Print, Wick Gap, GARCH Regime Flip & Prop Drawdown Shield. | `TypeScript` `React` `Kotlin` `Android` `TradingView` `Pine Script` | 🟢 Active |
...
| **[arch-configuration-i3-easy-setup](https://github.com/basantzp/arch-configuration-i3-easy-setup)** | 🖥️ Streamlined Arch Linux desktop configuration and automated developer workstation setup. | `Shell` `i3wm` `Arch Linux` `Config` | 🟢 Active |
<!-- PROJECTS:END -->
...
```
  Decentralized Architecture & EVM Exploration
  │
  ├── 🟢 Core Fundamentals (Solid Grounding)
  │    ├── Blockchain Consensus (PoW / PoS / Byzantine Fault Tolerance)
  │    ├── Cryptographic Primitives (Hashing, Merkle Trees, ECDSA)
  │    └── Solidity Syntax, Token Standards (ERC-20, ERC-721) & OpenZeppelin
  │
  ├── 🟡 Active Deep-Dives (In Progress)
  │    ├── EVM Memory, Storage Layout & Gas Optimization
  │    ├── DeFi Building Blocks (Automated Market Makers, Lending, Liquidity Pools)
  │    ├── Local Multi-Node Testnet Orchestration & Indexing
  │    └── Smart Contract Security Patterns & Attack Vectors (Reentrancy, Front-running)
  │
  └── 🔵 Upcoming Milestones (Roadmap)
       ├── Layer 2 Scaling Solutions (Optimistic Rollups & ZK-SNARKs)
...
<div align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=basantzp&show_icons=true&theme=tokyonight&hide_border=true&count_private=true&include_all_commits=true" alt="Basant's GitHub Stats" height="165" />
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=basantzp&layout=compact&theme=tokyonight&hide_border=true&langs_count=8" alt="Top Languages" height="165" />
</div>

<div align="center">
  <br>
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=basantzp&theme=tokyonight&hide_border=true" alt="GitHub Streak" height="165" />
</div>
...
<a href="mailto:basantpok90@gmail.com">
  <img src="https://img.shields.io/badge/Email-basantpok90%40gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white" alt="Email" />
</a>
<a href="https://github.com/basantzp">
  <img src="https://img.shields.io/badge/GitHub-basantzp-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" />
</a>

<br><br>

> *"In code we trust, on-chain we verify."* 🚀
