...
| **[omarchy](https://github.com/basantzp/omarchy)** | Tailored, hyper-automated Arch Linux & Hyprland environment featuring macOS Sequoia-style Wi-Fi & Battery Control Centers, dynamic Waybar workstation/bandwidth telemetry, and a complete autonomous AI engineering suite (Ruflo swarms, 273 Agency specialists, Strix penetration testing, Browser-Use, OpenViking context DB, and 163 scientific research skills). | `Python` `GTK4` `Hyprland` `Waybar` `Agent Skills` `Ruflo` `OpenViking` | 🟢 Active |
