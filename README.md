...
| **[omarchy](https://github.com/basantzp/omarchy)** | Tailored, hyper-automated Arch Linux & Hyprland environment with Real-Time Focus Turbo Engine, max-performance app prioritization, and developer tooling. | `Python` `Hyprland` `Waybar` `Systemd` `Linux Performance` | 🟢 Active |
